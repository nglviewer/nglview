...
def install_nglview_js_widgets(user=True,
                               symlink=False,
                               overwrite=True,
                               debug=False,
                               **kwargs):
    ...
    **kwargs: keyword arguments
    ...
    """
    nglivew_js_dirs = nbextensions.install_nbextension_python(
        'nglview', user=user, symlink=symlink, overwrite=overwrite, **kwargs)
    if debug:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        action="store_true")
    parser.add_argument(
        "-d", "--debug", help="print nglivew-js-widgets", action="store_true")
